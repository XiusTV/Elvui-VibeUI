...
function GBB.GetDungeonNames()
  local DefaultEnGB = {
    ...
    [ "BRDPRISON" ] = "Blackrock Depths: Prison",
    [ "BRDMANUF" ] = "Blackrock Depths: Manufactory",
    [ "BRDUCITY" ] = "Blackrock Depths: Upper City",
    [ "DM2" ] = "Dire Maul",
    [ "DME" ] = "Dire Maul: East",
    [ "DMN" ] = "Dire Maul: North",
    [ "DMW" ] = "Dire Maul: West",
    [ "STRAT" ] = "Stratholme",
    [ "SCHOLO" ] = "Scholomance",
    [ "LSCHOLO" ] = "Lower Scholomance",
    [ "USCHOLO" ] = "Upper Scholomance",
...
GBB.VanillDungeonNames   = {
  ...
  "ZF", "MARA", "ST", "BRD", "BRDPRISON", "BRDMANUF", "BRDUCITY", "LBRS", "DME", "DMN",
  "DMW", "STRAT", "SCHOLO", "LSCHOLO", "USCHOLO", "UBRS", "ONY", "MC", "ZG",
  "AQ20", "BWL", "AQ40", "NAXX", "BRC", "RDF",
}
