...
GBB.dungeonTagsLoc = {
  enGB = langSplit( {
    ...
    [ "BRD" ]    = "brd",
    [ "BRDPRISON" ] = "brdprison prison jail",
    [ "BRDMANUF" ] = "brdmanuf manufactory manuf manu factory",
    [ "BRDUCITY" ] = "brducity uppercity upper city emperor",
    ...
    [ "LSCHOLO" ] = "lscholo lower lowerScholo",
    [ "USCHOLO" ] = "uscholo upper upperScholo",
    [ "LBRS" ]   = "lower lbrs",
    [ "UBRS" ]   = "upper ubrs",
    ...
    [ "BRC" ]    = "brc blackrock caverns cavern",
    [ "RDF" ]    = "rdf random dungeon finder",
