# ElvUI_OptionsUI Git Repository Initialization Script
# Run this script to create a git repository for ElvUI_OptionsUI

Write-Host "Initializing Git Repository for ElvUI_OptionsUI..." -ForegroundColor Cyan
Write-Host ""
...
git commit -m "Initial commit: ElvUI_OptionsUI v1.0.0 for WotLK 3.3.5
...
Write-Host "   git remote add origin https://github.com/yourusername/ElvUI_OptionsUI.git"
