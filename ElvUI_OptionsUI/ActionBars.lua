			...
			auraTracker = {
				...
				args = {
					...
					description = {
						order = 2,
						type = "description",
						name = "Display buff/debuff duration remaining directly on action bar buttons. Shows time left for your abilities on the current target (e.g., Gift of the Wild buff, Moonfire DoT).",
					},
					enable = {
						order = 3,
						type = "toggle",
					...
					colorByTime = {
						...
						desc = "Change text color based on time remaining: Green (>10s), Yellow (5-10s), Red (<5s)",
						disabled = function() return not E.db.actionbar.auraTracker.enable end,
					},
					spacer1 = {
						order = 6,
